...
namespace Bitai.LDAPHelper.Tests
{
    public class BaseTests
    {
        ...
        /// </remarks>
        public MockLdapEntryAdapter CreateMockUserEntry(string firstName, string lastName, SearchLimits? searchLimits, out QueryFilters.AttributeFilter searchFilterSAMAccountName, out QueryFilters.AttributeFilter searchFilterDistinguishedName, string[] memberOfDistinguishedNames = null) {
            ...
            GenerateCommonUserSearchFilter(firstName, lastName, out searchFilterSAMAccountName, out searchFilterDistinguishedName);
        ...
        public void GenerateCommonUserSearchFilter(string firstName, string lastName, out QueryFilters.AttributeFilter searchFilterSAMAccountName, out QueryFilters.AttributeFilter searchFilterDistinguishedName) {
            ...
            searchFilterDistinguishedName = new QueryFilters.AttributeFilter(DTO.EntryAttribute.distinguishedName, new QueryFilters.FilterValue($"CN={firstName} {lastName},DC=domain,DC=com"));
        }
